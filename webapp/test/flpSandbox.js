					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Consultivazione Costi",
									"targetURL": "#sapmbem-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapmbem-display": {
								"semanticObject": "sapmbem",
								"action": "display",
								"description": "Consultivazione Costi",
								"title": "Consultivazione Costi",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.m.bem",
									"url": sap.ui.require.toUrl("sap/m/bem")
								}
							}
						}
					}
